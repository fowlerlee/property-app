...
export default MPeg = () => {
  ...
  const handleCreateSnipOfVideo = () => {
    FFmpegWrapper.clipFrames(selectedVideo.localFileName, selectedVideo.uri, startTime, endTime, userText);
  }
      ...
      {selectedVideo ? (
        <>
          <View style={styles.videoContainer}>
              <TextInput value={userText} placeholder="Enter image text" onChange={setUserText}></TextInput>
              <TextInput keyboardType="numeric" value={startTime} placeholder="Enter start time" onChange={setStartTime}></TextInput>
              <TextInput keyboardType="numeric" value={endTime} placeholder="Enter end time" onChange={setEndTime}></TextInput>
              <Pressable
                style={styles.buttonContainer}
                onPress={handleCreateSnipOfVideo}>
                <Text style={styles.buttonText}>Cut Video</Text>
            </Pressable>
            <Video
              ref={videoPlayerRef}
              style={styles.video}
